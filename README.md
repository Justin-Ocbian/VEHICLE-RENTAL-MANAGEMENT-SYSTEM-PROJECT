Steps to open the System

1.Download the whole file.
2.Turn on your Xampp and start both Apache and MySql
3.Open your donwloaded file and copy the database and then paste it inside the htdocs.
