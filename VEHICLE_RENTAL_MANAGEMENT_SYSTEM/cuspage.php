...
<head>
    ...
    <style>
        * {
        ...
        .hai {
            width: 100%;
            background: linear-gradient(to top, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 50%), url('https://wallpapercave.com/wp/wp5887446.jpg');
        ...
        .bbtn a:hover {
            cursor: pointer;
            background-color: rgba(164, 7, 255, 0.1);
            border-radius: 10px;
        }
...
<body>
    ...
    <div class="hai">
        <div class="navbar">
            <div class="icon">
                <h2 class="logo" style="color: #2056deff;">VRMS</h2>
            </div>
            <div class="menu"> 
                <ul>
                    <li class="bbtn">
