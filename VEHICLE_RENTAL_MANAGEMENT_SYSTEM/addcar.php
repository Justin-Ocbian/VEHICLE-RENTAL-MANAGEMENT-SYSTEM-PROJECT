...
body{
    background-image: url("https://s1.cdn.autoevolution.com/images/gallery/PORSCHE-718-Boxster-5572_37.jpg");
...
<button id="back"><a href="adminpage.php">HOME</a></button> 
 ...
 <div class="main">
        ...
        <div class="register">
        <h2 style="color: rgba(255, 208, 0, 1)">Enter Details Of New Car</h2>
