...
<head>
    ...
    <style>
        * {
        ...
        .hai {
            width: 100%;
            background: linear-gradient(to top, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 50%), url('https://s1.cdn.autoevolution.com/images/gallery/PORSCHE-718-Boxster-5572_37.jpg');
...
<body>
    ...
    <div class="hai">
        ...
        <div class="cont">
        <div id="home">
            <div class="rent"><b>Rent Your Dream Car!</b></div>
